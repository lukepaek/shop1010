...
<div class="py-3 bg-gray-100">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 my-2"><h1 class="m-0 h4 text-center text-lg-start">Register Now</h1></div>
            <div class="col-lg-6 my-2">
                <ol class="breadcrumb dark-link m-0 small justify-content-center justify-content-lg-end">
                    <li class="breadcrumb-item"><a class="text-nowrap" href="https://www.pxdraft.com/wrap/shopapp/html/account/sign-up.html#"><i class="bi bi-home"></i>Home</a></li>
    ...
    <div class="container">
        <div class="justify-content-center row">
            <div class="col-lg-10 col-xxl-6">
                <div class="card">
                    <div class="card-header bg-transparent py-3"><h3 class="h4 mb-0">Register</h3></div>
                    <div class="card-body">
                        <form class="">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label class="form-label col" for="exampleInputPassword_1">Conform Password<span class="text-danger">*</span></label> <input type="password" class="form-control" id="exampleInputPassword_1" placeholder="*********">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row align-items-center">
                                <div class="col"><button type="submit" class="btn btn-primary">Create Account</button></div>
                                <div class="col-12 col-sm text-sm-end mt-3 mt-sm-0">
                                    <span class="text-muted">Have an account? <a href="https://www.pxdraft.com/wrap/shopapp/html/account/sign-up.html">Login here</a></span>
                                </div>
                            </div>
                        </form>
                    </div>
